            ...
            <div className="row mb-3">
              <div className="col-md-6">
                ...
                <ul className="list-unstyled mb-0">
                  ...
                  <li><i className="bi bi-envelope-fill me-2"></i><strong>Email:</strong> {email || '—'}</li>
              ...
              <div className="col-md-6">
                ...
                <ul className="list-unstyled mb-0">
                  <li><i className="bi bi-person-badge me-2"></i><strong>Nombre:</strong> {vendedor?.nombre} {vendedor?.apellido}</li>
                  <li><i className="bi bi-envelope-fill me-2"></i><strong>Email:</strong> {vendedor?.email || '—'}</li>
                  <li><i className="bi bi-card-list me-2"></i><strong>Legajo:</strong> {vendedor?.legajo ?? '—'}</li>
                  <li>
                    <i className="bi bi-check-circle me-2"></i>
                    <strong>Estado:</strong>{' '}
                    <span className={`badge ${vendedor?.estado === 'active' ? 'bg-success' : 'bg-secondary'}`}>
                      {vendedor?.estado === 'active' ? 'Activo' : 'Inactivo'}
                    </span>
                  </li>
                </ul>
              </div>
